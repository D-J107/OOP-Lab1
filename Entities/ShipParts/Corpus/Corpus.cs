...
namespace Itmo.ObjectOrientedProgramming.Lab1.Entities.ShipParts.Corpus;

public abstract class Corpus : IDamagable
{
    private Capability _capability;

    protected Corpus(int physCap = 0, int photonCap = 0, int enormCap = 0)
    {
